    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex items-center gap-3">
        ...
        <PageHeader
          ...
          subtitle="Add a new physical resource to the enterprise catalog."
          breadcrumbs={[{ label: 'Home', path: '/dashboard' }, { label: 'Assets', path: '/assets' }, { label: 'Register' }]}
        />
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <Card title="Resource Profile & Identity">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="form-control">
              ...
              {errors.category_id && <span className="text-[10px] text-error mt-1">{errors.category_id.message as string}</span>}
            </div>
            ...
            <div className="form-control">
              ...
              <input
                type="text"
                placeholder="e.g. SN-DELL-LAT5430-10"
            ...
            <div className="form-control">
              ...
              <input
                ...
                className="input input-sm input-bordered rounded-lg text-xs"
              />
              {errors.manufacturer && <span className="text-[10px] text-error mt-1">{errors.manufacturer.message as string}</span>}
            </div>
            ...
            <div className="form-control">
              ...
              <input
                ...
                className="input input-sm input-bordered rounded-lg text-xs"
              />
              {errors.model && <span className="text-[10px] text-error mt-1">{errors.model.message as string}</span>}
            </div>
          </div>
        </Card>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="form-control">
              ...
              <input
                ...
                className="input input-sm input-bordered rounded-lg text-xs"
              />
              {errors.acquisition_date && <span className="text-[10px] text-error mt-1">{errors.acquisition_date.message as string}</span>}
            </div>
            ...
            <div className="form-control">
              ...
              />
              {errors.acquisition_cost && <span className="text-[10px] text-error mt-1">{errors.acquisition_cost.message as string}</span>}
            </div>
        ...
        {/* Lifecycle Condition & Assignment Card */}
        <Card title="Status, Condition & Location">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="form-control">
              <label className="label text-xs font-semibold text-base-content/60">Initial Status</label>
              <select
                {...register('status')}
                className="select select-sm select-bordered rounded-lg text-xs"
              >
            ...
            <div className="form-control">
              ...
              <input
                type="text"
                placeholder="e.g. Server Room A, Slot 1"
        ...
        <div className="flex justify-end gap-2.5">
          <Link to="/assets" className="btn btn-sm btn-ghost normal-case text-xs">
            Cancel
          </Link>
          <Button
            type="button"
